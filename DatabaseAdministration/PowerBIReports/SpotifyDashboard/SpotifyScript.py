...
client_id = '6a686fb91b6544acb90308bef18377d6'
client_secret = '8ead36a5a1fa4b3891b38a568acc2aee'
...
try:
    df_spotify = pd.read_csv('spotify-2023.csv', encoding='ISO-8859-1', on_bad_lines='skip')
except Exception as e:
    print(f"Error reading CSV file: {e}")

# Print column names for debugging
print("Columns in DataFrame:", df_spotify.columns)
